...
public class AcademicException extends RuntimeException{
	...
	private static final long serialVersionUID = 8629188488614246068L;
	...
	private AcademicException(TypeExceptionEnum type, LocationExceptionEnum location, String message,
	...
	public static AcademicException bulidTechnicalSeriviceException(String message) {
		return new AcademicException(TypeExceptionEnum.TECHNICAL, LocationExceptionEnum.SERVICE,
				message, null);
